...
> = {
  success: {
    ...
    icon: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#25d366" stroke-width="2.5" stroke-linecap="round"><path d="M20 6L9 17l-5-5"/></svg>`,
  },
  error: {
    color: "#ff5252",
    border: "rgba(255,82,82,0.28)",
    bg: "rgba(255,82,82,0.10)",
    icon: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#ff5252" stroke-width="2.5" stroke-linecap="round"><circle cx="12" cy="12" r="10"/><path d="M15 9l-6 6M9 9l6 6"/></svg>`,
  },
  warning: {
    color: "#ffa000",
    border: "rgba(255,160,0,0.28)",
    bg: "rgba(255,160,0,0.10)",
    icon: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#ffa000" stroke-width="2.5" stroke-linecap="round"><path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>`,
  },
  info: {
    color: "#4fc3f7",
    border: "rgba(79,195,247,0.28)",
    bg: "rgba(79,195,247,0.10)",
    icon: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#4fc3f7" stroke-width="2.5" stroke-linecap="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>`,
  },
};
...
const ToastCard = ({
  ...
  useEffect(() => {
    ...
    const tick = () => {
      const pct = Math.max(
        0,
        100 - ((Date.now() - start) / item.duration) * 100,
      );
      setProgress(pct);
