...
const LoginModal = ({ onClose, onSwitchToSignup, setLoading, colors }: LoginModalProps & { colors: typeof ThemeConfig.light }) => {
            ...
            <div style={modalStyle}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div style={formGroupStyle}>
                        ...
                        <input type="password" style={inputStyle} placeholder="Enter your password" required />
                    </div>
                    <button type="submit" style={btnFullStyle}>Sign In</button>
                </form>
                ...
                <div style={footerStyle}>
                    Don't have an account? <a style={linkStyle} onClick={onSwitchToSignup}>Sign up</a>
                </div>
            </div>
        </div>
    );
